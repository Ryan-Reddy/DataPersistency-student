...
INSERT INTO medewerkers (toelage) WHERE maandsal BETWEEN 3001 AND 4000
    VALUES 500
        ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
VALUES('D&P', 'Data & Persistency', 'ALG', 1)
    ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie)
VALUES('D&P', '2022-12-12', 7902, 'LEERDAM'), ('D&P', '2022-11-12', 7902, 'LEERDAM')
    ON CONFLICT DO NOTHING;                                                                                -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum)
    VALUES(7499, 'D&P', '2022-12-12'), (7698, 'D&P', '2022-12-12'), (7902, 'D&P', '2022-12-12');
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
