...
UPDATE medewerkers
SET toelage = 500
WHERE maandsal BETWEEN 3001.00 AND 4300.00;
...
-- TODO DETAIL:  Key (mnr)=(7499) is still referenced from table "inschrijvingen".
--  Cascading reference, de link is er nog..
--  DELETE CASCADE lukt wellicht wel.
